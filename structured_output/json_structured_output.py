...
json = {
    ...
    "properties":{
        ...
        "college_established_year":{
            "type":"integer",
            "description":"Year of establishment of the college"
        },
        "college_location":{
            "type":"string",
            "description":"location of the college, including the distance from the central city"
        },
        "courses_offered":{
            "type":"array",
            "items":{
            ...
            "description":"The list of courses offered in the college"
        },
        "minor_courses":{
            "type":["array","null"],
            "items":{
            ...
            "description":"The list of minor courses offered by the college"
        },
        "country":{
            "type":"array",
            "enum":["India","Out side India"],
            "items":{
                "type":"string"
            },
            "description":"The country in which the college is located, in India or Outside India"
        }      
    }
}
